def send_email(message, recipient, *, sender='university.help@gmail.com'):
    ...
    elif '.com' not in recipient[-4:] and '.ru' not in recipient[-3:] and '.net' not in recipient[-4:]:
        print(f'Невозможно отправить письмо с адреса {sender} на адрес {recipient}.')
    elif '.com' not in sender[-4:] and '.ru' not in sender[-3:] and '.net' not in sender[-4:]:
        print(f'Невозможно отправить письмо с адреса {sender} на адрес {recipient}.')
